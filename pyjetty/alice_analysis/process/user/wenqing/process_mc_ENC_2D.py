    ...
    for observable in self.observable_list:
      ...
      if observable == 'jet_ENC_RL':
        ...
        for trk_thrd in self.obs_settings[observable]:
          ...
          h1d_reco.GetXaxis().SetTitle('p^{det}_{T,ch jet}')
          h1d_reco.GetYaxis().SetTitle('Counts')
          ...
          h1d_gen.GetXaxis().SetTitle('p^{truth}_{T,ch jet}')
          h1d_gen.GetYaxis().SetTitle('Counts')
